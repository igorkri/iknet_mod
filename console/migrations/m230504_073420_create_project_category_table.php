 ...
 */
class m230504_073420_create_project_category_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('{{%project_category}}', [
            ...
            'seo_keywords_uk' => $this->string()->comment('SEO Ключи UK'),
            'seo_keywords_en' => $this->string()->comment('SEO Ключи EN'),
            'seo_keywords_ru' => $this->string()->comment('SEO Ключи RU'),
        ]);
    }
