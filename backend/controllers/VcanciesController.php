...
use common\models\search\VcanciesSearch;
...
/**
 * VcanciesController implements the CRUD actions for Vacancies model.
 */
class VcanciesController extends Controller
{
    ...
    {
        $searchModel = new VcanciesSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            ...
            $model->published = intval($post['published']);
