...
<div class="container project-category-form">
    ...
    <div class="row">
                <div class="col-6">
                    <?= $form->field($model, 'parent_id')->dropDownList(ArrayHelper::map(\common\models\ProjectCategory::find()->with(['parent', 'parents'])
                        ->where(['parent_id' => 10])
                        ->asArray()->all(),
