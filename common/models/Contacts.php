...
class Contacts extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'adres_uk' => Yii::t('app', 'Адреса UK'),
            'adres_en' => Yii::t('app', 'Адреса EN'),
            'adres_ru' => Yii::t('app', 'Адреса RU'),
            'coment_uk' => Yii::t('app', 'Коментар UK'),
            'coment_en' => Yii::t('app', 'Коментар EN'),
            'coment_ru' => Yii::t('app', 'Коментар RU'),
            'image_uk' => Yii::t('app', 'Картинка UK'),
            'image_en' => Yii::t('app', 'Картинка EN'),
            'image_ru' => Yii::t('app', 'Картинка RU'),
